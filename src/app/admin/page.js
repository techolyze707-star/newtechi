...
export default function AdminDashboard() {
  ...
  const adminActions = [
    ...
    // },
    // {
    //   title: 'Create Site Content',
    //   description: 'Add educational content with hierarchy',
    //   icon: BookOpen,
    //   href: '/admin/site/upload',
  ...
  return (
    <div className="min-h-screen mt-20 bg-gradient-to-br from-gray-50 via-white to-indigo-50">
      {/* Background Elements */}
            ...
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Techolyze Management Panel</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2 overflow-x-auto">
                ...
                {/* <button
                  ...
                  className={`px-3 py-2 rounded-lg transition-colors whitespace-nowrap text-sm ${activeTab === 'sites'
                    ? 'bg-indigo-100 text-indigo-700'
                    : 'text-gray-500 hover:text-gray-700'
                    }`}
                >
